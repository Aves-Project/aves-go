...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{								// 1 milion 950k AVES / aves 18 digits
			common.HexToAddress("0xA75Bd5d4f25b388DA9b17f3aa3ef604e3aabAEF5"): {Balance: new(big.Int).Mul(big.NewInt(1950000), big.NewInt(1e18))},
			common.HexToAddress("0xB0061ACb424DB252D52a9E97B90824300855885E"): {Balance: new(big.Int).Mul(big.NewInt(50000), big.NewInt(1e18))},
		},
